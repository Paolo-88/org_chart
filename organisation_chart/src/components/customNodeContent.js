          ...
          {props.data.team === "" ? (
            <div style={styles.nodeContent}>
              ...
              <div style={styles.nodeInfo}>
                ...
                <div style={styles.nodeSurname}>{props.data.surname}</div>
                <div style={styles.nodeRole}>{props.data.positionName}</div>
                <div style={styles.nodeRole}>{props.data.positionSurname}</div>
            ...
            <div style={styles.nodeTeam}>
              ...
              <div style={styles.nodeTeamSurname}>{props.data.team}</div>
